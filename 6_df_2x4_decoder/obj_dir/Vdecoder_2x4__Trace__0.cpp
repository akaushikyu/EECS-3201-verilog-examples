...
void Vdecoder_2x4___024root__trace_chg_0_sub_0(Vdecoder_2x4___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+1,(vlSelfRef.ab_i),2);
    bufp->chgCData(oldp+2,(vlSelfRef.wxyz_o),4);
    bufp->chgBit(oldp+3,(((IData)(vlSelfRef.decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_1) 
                          & ((IData)(vlSelfRef.ab_i) 
                             >> 1U))));
    bufp->chgBit(oldp+4,(((IData)(vlSelfRef.decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_4) 
                          & ((IData)(vlSelfRef.ab_i) 
                             >> 1U))));
    bufp->chgBit(oldp+5,(((~ ((IData)(vlSelfRef.ab_i) 
                              >> 1U)) & (IData)(vlSelfRef.decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_1))));
    bufp->chgBit(oldp+6,(((~ ((IData)(vlSelfRef.ab_i) 
