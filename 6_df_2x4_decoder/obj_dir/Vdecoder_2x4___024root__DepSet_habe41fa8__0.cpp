...
VL_INLINE_OPT void Vdecoder_2x4___024root___ico_sequent__TOP__0(Vdecoder_2x4___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_1 
        = ((IData)(vlSelfRef.enable) & (IData)(vlSelfRef.ab_i));
    vlSelfRef.decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_4 
        = ((~ (IData)(vlSelfRef.ab_i)) & (IData)(vlSelfRef.enable));
    vlSelfRef.wxyz_o = (((0xfffffff8U & (((IData)(vlSelfRef.decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_1) 
                                          << 3U) & 
                                         ((IData)(vlSelfRef.ab_i) 
                                          << 2U))) 
                         | (0xfffffffcU & (((IData)(vlSelfRef.decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_4) 
                                            << 2U) 
                                           & ((IData)(vlSelfRef.ab_i) 
                                              << 1U)))) 
                        | ((((~ ((IData)(vlSelfRef.ab_i) 
