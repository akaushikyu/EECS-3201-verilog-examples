...
void Vsimple_and___024root__trace_chg_0_sub_0(Vsimple_and___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vsimple_and___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsimple_and___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vsimple_and___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vsimple_and___024root__trace_chg_0_sub_0(Vsimple_and___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsimple_and___024root__trace_chg_0_sub_0\n"); );
    Vsimple_and__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vsimple_and___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsimple_and___024root__trace_cleanup\n"); );
    // Init
    Vsimple_and___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<Vsimple_and___024root*>(voidSelf);
    Vsimple_and__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
