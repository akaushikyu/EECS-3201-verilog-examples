...
VL_INLINE_OPT void Vsimple_circuit___024root___ico_sequent__TOP__0(Vsimple_circuit___024root* vlSelf) {
    ...
    CData/*0:0*/ __VdfgRegularize_h0dff6736_0_3;
    __VdfgRegularize_h0dff6736_0_3 = 0;
    // Body
    __VdfgRegularize_h0dff6736_0_2 = ((~ (IData)(vlSelfRef.z)) 
                                      & (IData)(vlSelfRef.y));
    __VdfgRegularize_h0dff6736_0_3 = (1U & ((~ (IData)(vlSelfRef.y)) 
                                            & (~ (IData)(vlSelfRef.z))));
    vlSelfRef.f = (((~ (IData)(vlSelfRef.x)) & (IData)(__VdfgRegularize_h0dff6736_0_3)) 
                   | (((~ (IData)(vlSelfRef.x)) & (IData)(__VdfgRegularize_h0dff6736_0_2)) 
                      | ((IData)(vlSelfRef.x) & ((IData)(__VdfgRegularize_h0dff6736_0_3) 
