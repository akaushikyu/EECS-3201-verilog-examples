...
void Vcomparator___024root__trace_chg_0_sub_0(Vcomparator___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgCData(oldp+0,(vlSelfRef.inp_1),4);
    bufp->chgCData(oldp+1,(vlSelfRef.inp_2),4);
    bufp->chgBit(oldp+2,(vlSelfRef.eq));
    bufp->chgBit(oldp+3,(vlSelfRef.gt));
    bufp->chgBit(oldp+4,(vlSelfRef.lt));
}
