...
void Vdecoder_2x4___024root___eval_ico(Vdecoder_2x4___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecoder_2x4___024root___eval_ico\n"); );
...
VL_INLINE_OPT void Vdecoder_2x4___024root___ico_sequent__TOP__0(Vdecoder_2x4___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecoder_2x4___024root___ico_sequent__TOP__0\n"); );
    Vdecoder_2x4__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_2;
    decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_2 = 0;
    // Body
    decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_2 
        = ((~ ((IData)(vlSelfRef.ab_i) >> 1U)) & (IData)(vlSelfRef.enable));
    vlSelfRef.wxyz_o = (((((IData)(vlSelfRef.enable) 
                           & (IData)((3U == (IData)(vlSelfRef.ab_i)))) 
                          << 3U) | (((IData)(vlSelfRef.enable) 
                                     & (IData)((2U 
                                                == (IData)(vlSelfRef.ab_i)))) 
                                    << 2U)) | ((((IData)(decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_2) 
                                                 & (IData)(vlSelfRef.ab_i)) 
                                                << 1U) 
                                               | ((~ (IData)(vlSelfRef.ab_i)) 
                                                  & (IData)(decoder_2x4__DOT____VdfgRegularize_h90aad52c_0_2))));
}

void Vdecoder_2x4___024root___eval_triggers__ico(Vdecoder_2x4___024root* vlSelf);

bool Vdecoder_2x4___024root___eval_phase__ico(Vdecoder_2x4___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecoder_2x4___024root___eval_phase__ico\n"); );
    Vdecoder_2x4__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VicoExecute;
    // Body
    Vdecoder_2x4___024root___eval_triggers__ico(vlSelf);
    __VicoExecute = vlSelfRef.__VicoTriggered.any();
    if (__VicoExecute) {
        Vdecoder_2x4___024root___eval_ico(vlSelf);
    }
...
#ifdef VL_DEBUG
            Vdecoder_2x4___024root___dump_triggers__ico(vlSelf);
#endif
            VL_FATAL_MT("decoder_2x4.v", 5, "", "Input combinational region did not converge.");
        }
        __VicoIterCount = ((IData)(1U) + __VicoIterCount);
        __VicoContinue = 0U;
        if (Vdecoder_2x4___024root___eval_phase__ico(vlSelf)) {
            __VicoContinue = 1U;
        }
